...
public class EditBukuTamu extends Activity {
	...
	private static final String url_pendaftaran_details = "http://whypac.hol.es/pendaftaran/get_pendaftaran_details.php";

	// url untuk pembaharuan buku tamu
	private static final String url_update_pendaftaran = "http://whypac.hol.es/pendaftaran/update_pendaftaran.php";

	// url untuk menghapus buku tamu
	private static final String url_delete_pendaftaran = "http://whypac.hol.es/pendaftaran/delete_pendaftaran.php";

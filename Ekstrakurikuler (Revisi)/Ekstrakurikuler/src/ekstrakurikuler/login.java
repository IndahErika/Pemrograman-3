...
public class login extends javax.swing.JFrame {
     ...
     */
    public JadwalEkskul JadwalEkskul;
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ekstrakurikuler/logo kgr1.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
          try{
            String sql = "select * from admin where username = '"+username.getText()+"'and password = '"+String.valueOf(password.getPassword())+"'";
            ResultSet rsset = stmt.executeQuery(sql);   
            if(rsset.next()){
                JadwalEkskul = new JadwalEkskul();
                JadwalEkskul.setVisible(true);
                this.dispose();
